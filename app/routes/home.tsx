...
export default function Home() {
  ...
  const [importName, setImportName] = useState("Existing treasury"); const [importHandle, setImportHandle] = useState(""); const [importNetwork, setImportNetwork] = useState<Network>("mainnet"); const [paymentScriptText, setPaymentScriptText] = useState(""); const [stakeScriptText, setStakeScriptText] = useState(""); const [copied, setCopied] = useState(false);
